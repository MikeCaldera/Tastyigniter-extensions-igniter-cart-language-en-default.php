...
return [
    ...
    'text_component_desc' => 'Sorry, we are experiencing some technical difficulties displaying your cart.',
    'text_checkout_component_title' => 'Checkout Component',
    'text_checkout_component_desc' => 'Sorry, we are experiencing some technical difficulties displaying the checkout.',
    ...
    'text_update' => 'Update',
    'text_is_closed' => 'Sorry, our restaurant is currently closed.',
    'text_is_unavailable' => 'Sorry, the selected menu item is currently unavailable.',
    ...
    'text_min_order_total' => 'Your order is below the %s minimum for %s orders, please add more items to checkout.',
    ...
    'alert_menu_added' => 'Menu item has been added to your order.',
    ...
    'alert_no_menu_selected' => 'We apologize, but it seems that you have not selected any menu items to add to your order. Please go back to the menu and select a menu item before proceeding with your order.',
    ...
    'alert_coupon_not_applied' => 'We apologize for the inconvenience, but unfortunately, your coupon cannot be applied to orders below %s.',
    'alert_coupon_maximum_reached' => 'Maximum number of redemptions for the coupon has been reached.',
    'alert_coupon_order_restriction' => 'Your coupon cannot be applied to <b>%s</b> orders.',
    'alert_menu_not_within_mealtimes' => '%s is not available at this time.',
    'alert_menu_not_within_mealtimes_option' => '%s (%s - %s)',
    'alert_coupon_location_restricted' => 'Your coupon cannot be applied to the selected order location.',
    'alert_menu_location_restricted' => 'Menu [%s] does not belong to the selected order location.',
    ...
    'checkout' => [
        'text_heading' => 'Proceed to Checkout',
        'text_checkout' => 'We know you\'re hungry, but please confirm your details before payment.',
        'text_payments' => 'Please choose your payment method.',
        'text_address' => 'Enter a new or an existing delivery address.',
        'text_ip_warning' => 'For the safety of our customers, we log all IP addresses for fraud prevention purposes.',
        ...
        'text_success_message' => 'Your order has been received.',
